    ...
    <div style={{ backgroundColor: "#fcf8fe" }}>
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mb-10 text-base leading-relaxed" style={{ color: "#5f5e68" }}>
          ...
          <span style={{ color: "#4a4bd7" }}>fluidcal.vercel.app</span>. This Privacy Policy explains
          ...
          <section>
            ...
            <ul className="flex flex-col gap-3 pl-4">
              <li className="flex flex-col gap-1">
                <span className="text-sm font-semibold" style={{ color: "#32323b" }}>
                  Account information
                </span>
          ...
          <section>
            ...
            <ul className="flex flex-col gap-3 pl-4">
              ...
              <li className="flex flex-col gap-1">
                ...
                <span className="text-sm leading-relaxed" style={{ color: "#5f5e68" }}>
                  Our transactional email provider. Your name and email address are shared with
                  Resend only to deliver booking confirmation and notification emails.
                </span>
              </li>
              <li className="flex flex-col gap-1">
                <span className="text-sm font-semibold" style={{ color: "#32323b" }}>
